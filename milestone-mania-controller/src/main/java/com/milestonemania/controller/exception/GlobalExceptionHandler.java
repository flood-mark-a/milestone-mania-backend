...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAttemptNotFoundException(
        ...
        String correlationId = CorrelationIdUtil.generateCorrelationId();
        logger.warn("Attempt not found - CorrelationId: {}, Message: {}", correlationId, ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidAttemptStateException(
        ...
        String correlationId = CorrelationIdUtil.generateCorrelationId();
        logger.warn("Invalid attempt state - CorrelationId: {}, Message: {}", correlationId, ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInsufficientMilestonesException(
        ...
        String correlationId = CorrelationIdUtil.generateCorrelationId();
        logger.error("Insufficient milestones - CorrelationId: {}, Message: {}", correlationId, ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(
        ...
        String correlationId = CorrelationIdUtil.generateCorrelationId();
        logger.error("Unexpected error - CorrelationId: {}, RequestURI: {}, Error: {}", 
