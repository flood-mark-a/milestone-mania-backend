...
public class ErrorResponse {
    ...
    @Schema(description = "User-friendly error message", example = "Game not found with slug: adventure-timeline")
    private String message;
    
    @Schema(description = "Request path that caused the error", example = "/api/games/adventure-timeline")
    private String path;
