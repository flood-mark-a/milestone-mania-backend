...
@OpenAPIDefinition(
    info = @Info(
        ...
        version = "1.0.0",
        description = "REST API for the Milestone Mania timeline ordering game. " +
                     "Players order historical milestones chronologically to complete challenges.",
        contact = @Contact(
            name = "Milestone Mania Team",
            email = "support@milestonemania.com"
        ),
        license = @License(
            name = "MIT License",
    ...
    servers = {
        ...
        @Server(
            ...
            url = "https://api.milestonemania.com"
        )
    }
)
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .components(new Components()
                        ...
                        .addResponses("ServiceUnavailable", createErrorResponse(
                                "Service Unavailable",
